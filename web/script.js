    ...
    fetch('cnt.txt')
        ...
        .then(text => {
            if (text === "" || text === "12") {
                ...
                document.getElementById("cntButtons").innerHTML = "Bitte warten - Ihr Zwölftonspiel wird erstellt ... <br> Please wait - your twelve-tone piece is being generated ... <br> Bitte halten Sie den Hörer ans Ohr.<br>Please hold the earphone to your ear.";
            } else {
